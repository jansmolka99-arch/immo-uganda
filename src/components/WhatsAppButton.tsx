...
export default function WhatsAppButton() {
  ...
  const phone = '256700000000'; // placeholder number
  const message = encodeURIComponent('Hi! I found your listing on ImmoUganda and would like more information.');
    ...
    <div style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 1000 }}>
      ...
      {showTooltip && (
        <div style={{
          ...
          boxShadow: '0 4px 24px rgba(0,0,0,0.15)', border: '1px solid #E9ECEF',
          width: '280px',
        }}>
          ...
          <p style={{ fontSize: '12px', color: '#6C757D', marginBottom: '12px' }}>
            Chat with us on WhatsApp. We&apos;re here to help you find your dream home in Uganda.
          </p>
          <a
